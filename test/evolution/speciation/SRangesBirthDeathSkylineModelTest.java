...
//
//        StratigraphicRange sr1 = new StratigraphicRange();
//        Taxon taxon1_first = new Taxon("t8_2");
//        Taxon taxon1_last = new Taxon("t8_3");
//        sr1.setInputValue("firstOccurrence", taxon1_first);
//        sr1.setInputValue("lastOccurrence", taxon1_last);
//        StratigraphicRange sr2 = new StratigraphicRange();
//        Taxon taxon2_first = new Taxon("t2_5");
////        Taxon taxon2_last = new Taxon("2_last");
//        sr2.setInputValue("firstOccurrence", taxon2_first);
//        sr2.setInputValue("lastOccurrence", taxon2_first);
//        StratigraphicRange sr3 = new StratigraphicRange();
//        Taxon taxon3_first = new Taxon("t5_9");
////        Taxon taxon3_last = new Taxon("t5_9");
//        sr3.setInputValue("firstOccurrence", taxon3_first);
...
//        model.setInputValue("netDiversification", new RealParameter("0.741948792757466  0.789167955564335 0.884340192563832 0.778403025213629"));
//        model.setInputValue("turnOver", new RealParameter("0.628559807641432 0.351026857178658 0.254019139148295 0.739752432750538"));
//        model.setInputValue("rho", new RealParameter("0.979054914228618"));
//        model.setInputValue("samplingProportion", new RealParameter("0.663249239558354 0.691511909663677 0.613048779964447 0.57168759717606"));
//
//        model.initAndValidate();
//        System.out.println(model.calculateLogP());
//

 ...
 * Last edited by Kate Truman, 2026
 */
public class SRangesBirthDeathSkylineModelTest extends TestCase {

    // Test A
    // Confirm that likelihood for a small tree with constant rates matches the likelihood calculated by the sRanges package.
    // In this test-case the skyline intervals all have the same diversification rates.
    @Test
    public void testLikelihood() throws Exception {
        ...
        // Likelihood is accurate to 9 decimal places. Floating point calculations can introduce errors on smaller scales.
    ...
    // Test B
    // Check likelihood matches manual calculations for tree with three stratigraphic ranges, including a range with only one fossil
    @Test
    ...
    // Test C
    // Compare likelihood to manual calculation for small tree where species 3 has one fossil occurrence and goes extinct
    @Test
    ...
    // Use the same tree as a test A, but use different skyline interval rates and compare to manual calculation.
    @Test
    ...
    // Test D
    // Use constant rates and tree as in test A but do not condition on survival
    @Test
    ...
    // Test E
    // Same as test D but use birth, death and sampling parameterization 
    // rather than diversification, turnover and sampling proportion.
    @Test
    ...
    // Test F
    // Calculate likelihood for larger tree with constant rates and compare to sRanges package calculation.
    @Test
